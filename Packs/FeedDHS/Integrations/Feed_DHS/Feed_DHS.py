...
class TaxiiClient:
    ...
    def __init__(self, pem: str, crt: str, verify: Optional[Union[str, bool]] = True):
    ...
    def _request(self, url: str, data: Union[Text, bytes]) -> str:
...
def main():
    ...
    client = TaxiiClient(key, crt, params.get('insecure') == 'true')
